{
  description = "cloud-sync-tuner - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 cloud-sync-tuner development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P cloud-sync-tuner.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/cloud-sync-tuner $out/bin/  # Rust
            # cp bin/cloud-sync-tuner $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/cloud-sync-tuner";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-cloud-sync-tuner" {
